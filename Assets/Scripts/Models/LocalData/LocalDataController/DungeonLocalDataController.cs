...
namespace Models.LocalData.LocalDataController
{
    public class DungeonLocalDataController : ILocalDataController
    {
        ...
        public void InitData()
        {
            ...
            {
                this.dungeonModeBlueprint.ForEach(dungeon =>
                {
                    this.dungeonLocalData.dungeonData.Add(dungeon.Key,new DungeonData(){Id = dungeon.Key,IsUnlock = false,NumberCompleted = 0});
                });
            }
        ...
        public bool CheckDungeonIsUnlock(string dungeonId)
        {
            return this.dungeonLocalData.dungeonData[dungeonId].IsUnlock;
        }

        public DungeonData GetDungeonData(string dungeonId)
        {
            return this.dungeonLocalData.dungeonData[dungeonId];
        }
        ...
        {
            this.dungeonLocalData.dungeonData[dungeonId].NumberCompleted++;
        }
    }
}