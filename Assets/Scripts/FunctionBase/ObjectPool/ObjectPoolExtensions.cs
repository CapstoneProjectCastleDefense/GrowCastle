...
namespace FunctionBase.Utilities.ObjectPool {
    public static class ObjectPoolExtensions {
        ...
        public static void CleanUpPooled(this GameObject prefab) { ObjectPoolManager.Instance.CleanUpPool(prefab); }

        public static void CleanUpPooled<T>(this T prefab) where T : Component { ObjectPoolManager.Instance.CleanUpPool(prefab.gameObject); }

        public static void CleanUpAll(this GameObject prefab) { ObjectPoolManager.Instance.CleanUpAll(prefab); }

        public static void CleanUpAll<T>(this T prefab) where T : Component { ObjectPoolManager.Instance.CleanUpAll(prefab.gameObject); }
