namespace Runtime.Extensions
{
    ...
    {
        public static void SetStat<T>(this IHaveStatsModel haveStats, StatEnum statEnum, T value) { haveStats.BaseStats[statEnum] = (typeof(T), value); }

        public static T GetStat<T>(this IHaveStatsModel haveStats, StatEnum statEnum)
        {
            haveStats.BaseStats.TryGetValue(statEnum, out var value);
            if (value.Item1 == null)
            {
                return default;
            }
            ...
            return (T)haveStats.BaseStats[statEnum].Item2;
        }
        ...
        {
            otherStats.BaseStats.ForEach(stat => haveStats.PlusStat(stat.Key, stat.Value));
        }

        public static void Minus(this IHaveStatsModel haveStats, IHaveStatsModel otherStats)
        {
            otherStats.BaseStats.ForEach(stat => haveStats.MinusStat(stat.Key, stat.Value));
        }
